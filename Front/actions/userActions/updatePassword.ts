...
export async function UpdatePassword({currentPassword, newPassword, confirmationPassword}: {currentPassword: string, newPassword: string, confirmationPassword: string}): Promise<void> {
